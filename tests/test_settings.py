...
class TestSettings:
    ...
    def test_excludes_test_files(self):
        pattern = settings.Settings.EXCLUDE_FILENAME_PATTERNS[1]
    ...
    def test_excludes_migration_files(self):
        pattern = settings.Settings.EXCLUDE_FILENAME_PATTERNS[2]
